...
async function authRoutes(fastify) {
  ...
  fastify.post('/users/invite', {
    ...
    if (!['super_admin', 'admin', 'scanner', 'reconciliation_specialist', 'admin_volunteers', 'team_leader_volunteers'].includes(role)) {
  ...
  fastify.put('/users/:id', {
    ...
    if (role && ['super_admin', 'admin', 'scanner', 'reconciliation_specialist', 'admin_volunteers', 'team_leader_volunteers'].includes(role)) updateData.role = role;
