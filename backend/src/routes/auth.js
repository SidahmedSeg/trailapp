...
async function authRoutes(fastify) {
  ...
  fastify.post('/users/invite', {
    ...
    if (!['super_admin', 'admin', 'scanner', 'reconciliation_specialist', 'volunteers_manager'].includes(role)) {
  ...
  fastify.put('/users/:id', {
    ...
    if (role && ['super_admin', 'admin', 'scanner', 'reconciliation_specialist', 'volunteers_manager'].includes(role)) updateData.role = role;
