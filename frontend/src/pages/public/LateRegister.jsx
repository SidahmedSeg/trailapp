...
import { Loader2, AlertCircle, Clock, User, Mail, MapPin, Phone, Shirt, Trophy, FileCheck } from 'lucide-react';
...
export default function LateRegister() {
  ...
  function handleSubmit(e) {
    ...
    sessionStorage.setItem(`late_register_form_${token}`, JSON.stringify(form));
    navigate(`/late-register/${token}/recap`);
  }
  ...
  return (
    <PublicLayout title="Inscription tardive" event={event}>
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-5 mb-6 flex items-start gap-3">
            ...
            <div>
              <p className="font-semibold text-amber-900 mb-1">
                Inscription tardive — Dossard #{tokenData.bibNumber} réservé pour vous
              </p>
              <p className="text-sm text-amber-800">
                Remplissez le formulaire ci-dessous, puis procédez au paiement pour finaliser votre inscription. Vous recevrez un email de confirmation avec votre dossard.
              </p>
            </div>
          </div>
